...
<body>
    <form class="add_customer_form" action="./edit_customer_action.php" method="post">
        ...
        <div class="flex-container">
            ...
            <div  class=container>
                <select name="branch">
                    <option value="kathmandu" <?php if ($branch == 'kathmandu') {?> selected="selected" <?php }?>>Lahore</option>
                    <option value="delhi" <?php if ($branch == 'delhi') {?> selected="selected" <?php }?>>Islamabad</option>
                    <option value="newyork" <?php if ($branch == 'newyork') {?> selected="selected" <?php }?>>Mianwali</option>
                    <option value="paris" <?php if ($branch == 'paris') {?> selected="selected" <?php }?>>Karachi</option>
                    <option value="riyadh" <?php if ($branch == 'riyadh') {?> selected="selected" <?php }?>>Multan</option>
                    <option value="moscow" <?php if ($branch == 'moscow') {?> selected="selected" <?php }?>>Musa Khel</option>
                </select>
            </div>
        </div>
